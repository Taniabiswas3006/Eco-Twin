...
export default function BlogPage() {
  return (
    <div className="min-h-screen bg-[#f4fcf4] flex flex-col items-center font-sans pb-24">
      ...
      <article className="w-full max-w-3xl px-8 pt-12 md:pt-20">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-neutral-900 leading-[1.1] mb-8 tracking-tight">
            Small Changes, <br/>
            Real Impact.
          </h1>
          
          <div className="flex items-center gap-6 text-neutral-400 text-sm border-y border-neutral-100 py-6">
        ...
        <motion.div
           ...
           className="w-full h-80 bg-white rounded-[2.5rem] mb-16 shadow-xl shadow-neutral-200/50 border border-white relative overflow-hidden flex items-center justify-center group"
        >
        ...
        >
          <section className="space-y-8 text-neutral-600 leading-[1.8] text-lg font-medium">
            ...
            <blockquote className="border-l-4 border-[#5c9853] pl-8 py-2 md:py-4 my-12 bg-white/50 rounded-r-2xl italic text-neutral-800 text-xl font-serif">
          ...
          <div className="mt-20 pt-10 border-t border-neutral-100 flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <span className="text-2xl font-serif italic font-bold text-neutral-800">Tania Biswas</span>
