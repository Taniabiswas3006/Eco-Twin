...
import { Leaf, Zap, Trash2, ChevronRight, Activity, TrendingUp, TrendingDown, Settings, Menu, X } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="w-full bg-[#f4fcf4] flex flex-col items-center relative font-sans">
      ...
      <nav className="w-full max-w-7xl px-4 sm:px-8 py-4 sm:py-6 flex justify-between items-center z-20">
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden fixed inset-x-0 top-[72px] z-50 bg-white/95 backdrop-blur-lg border-b border-neutral-100 shadow-xl px-6 py-6 flex flex-col gap-4"
          >
      ...
      {/* Main Hero Container */}
      <div className="w-full max-w-7xl px-4 sm:px-8 pt-8 sm:pt-12 pb-12 sm:pb-24 flex flex-col lg:flex-row items-center justify-between z-10 gap-8 sm:gap-12 flex-1">
        ...
        <div className="flex-1 max-w-2xl z-20 text-center lg:text-left">
           <motion.h1 
             ...
             className="text-3xl sm:text-4xl md:text-5xl lg:text-[4.5rem] font-extrabold tracking-tight text-neutral-800 leading-[1.1] mb-4 sm:mb-6"
           >
             Model Your Life.<br/>
           ...
           >
             <Link to="/signup">
               <button className="bg-[#5c9853] hover:bg-[#4b7a44] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg transition-transform active:scale-95 shadow-xl shadow-[#5c9853]/20">
                 Start Your Analysis
               </button>
             </Link>
           </motion.div>
      ...
      {/* Bottom Features Row */}
      <div className="w-full max-w-5xl px-4 sm:px-8 pb-4 z-20 relative">
        <motion.div 
